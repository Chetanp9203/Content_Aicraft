                ...
                <div>
                    <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
                        ...
                        <div className="relative z-20 w-full flex justify-between lg:w-max md:px-0">
                            <Image className='flex space-x-2 items-center ' src={Logo} alt='' height={100} width={100} />
                        ...
                        <div className="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border-none  shadow-2xl shadow-gray-600/10 justify-end w-full invisible opacity-0 translate-y-1  absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
                            lg:relative lg:scale-100 lg:peer-checked:translate-y-0 lg:translate-y-0 lg:flex lg:flex-row lg:items-center lg:gap-0 lg:p-0 lg:bg-transparent lg:w-7/12 lg:visible lg:opacity-100 lg:border-none
                            peer-checked:scale-100 peer-checked:opacity-100 peer-checked:visible lg:shadow-none 
                            dark:shadow-none dark:bg-gray-800 dark:border-gray-700">
                            
                        </div>
                            <div className="mt-12 lg:mt-0 hidden md:block">
                                <a
                                    href="/dashboard"
                                    className="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-cyan-700 before:transition 
